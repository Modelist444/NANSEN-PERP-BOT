...
def run_tests():
    ...
    print(f"    Signals: {config.min_signals_required}/5 required")
    ...
    try:
        ...
        print(f"    TP1 (60%): ${exits['tp1']:,.2f} (+{(exits['tp1']-95000)/95000*100:.2f}%)")
        print(f"    TP2 (40%): ${exits['tp2']:,.2f} (+{(exits['tp2']-95000)/95000*100:.2f}%)")
